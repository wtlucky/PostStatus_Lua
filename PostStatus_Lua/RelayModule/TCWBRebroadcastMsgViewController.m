...
- (void)viewDidLoad
{
    ...
    NSString *strRebroadcast = @"广播";//[main localizedStringForKey:kLanguageRebroadcast value:nil table:kTCWBTable];
    ...
    NSString *strCancel = @"取消";//[main localizedStringForKey:KLanguageCancel value:nil table:kTCWBTable];
    ...
    // 发送
    NSString *strSend = @"发送";//[main localizedStringForKey:kLanguageSend value:nil table:kTCWBTable];
