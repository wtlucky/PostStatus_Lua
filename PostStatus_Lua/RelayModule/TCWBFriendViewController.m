...
- (void)viewDidLoad
{
    ...
    NSString *strCancel = @"返回";//[main localizedStringForKey:kLanguageBack value:nil table:kTCWBTable];
    ...
    NSString *strFriends = @"好友列表";//[main localizedStringForKey:kLanguageFriends value:nil table:kTCWBTable];
