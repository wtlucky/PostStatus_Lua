...
- (void)saveAccessTokenInfo:(NSString *)code{
    ...
    //Modified by wtlucky on 2013年07月23日.
    NSDictionary *authData = [NSDictionary dictionaryWithObjectsAndKeys:
                              self.accessToken, @"AccessTokenKey",
                              [accessDic objectForKey:@"expires_in"], @"ExpirationDateKey",
                              self.name, @"Name",
                              self.refreshToken, @"refresh_token",
                              self.openId, @"OpenID", nil];
    [[NSUserDefaults standardUserDefaults] setObject:authData forKey:@"CocTCWeiboAuthData"];
