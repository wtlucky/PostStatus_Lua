...
- (void)viewDidLoad
{
    ...
    NSString *strRebroadcast = @"转播";//[main localizedStringForKey:kLanguageRelay value:nil table:kTCWBTable];
    ...
    // 转播
    NSString *strSend = @"转播";//[main localizedStringForKey:kLanguageRelay value:nil table:kTCWBTable];
